...
//   return (
// <div
//   className="h-screen w-64 bg-white flex flex-col justify-between 
//   shadow-[4px_0_15px_-4px_rgba(161,0,255,0.05)] border-none"
// >
//       {/* Logo */}
//       <div>
//         <div className="text-[#c63bff] text-2xl font-bold px-6 py-5 flex justify-center items-center gap-2">
//           <Business /> LOGO
//         </div>

//         {/* Removed visible divider line to avoid double border */}
//         <Divider sx={{ borderColor: "transparent" }} />

//         {/* Main navigation */}
//         <nav className="flex flex-col px-4 gap-2 pt-6">
//           {/* Dashboard */}
//           <Link to="/superadmin/dashboard" className="w-full">
//             <button
//               className={`flex items-center gap-3 px-4 py-3 rounded-xl w-full text-sm font-medium transition-all duration-300 ${
...
//           {/* Menu Manager */}
//           <Link to="/superadmin/menus" className="w-full">
//             <button
//               className={`flex items-center gap-3 px-4 py-3 rounded-xl w-full text-sm font-medium transition-all duration-300 ${
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 overflow-hidden">
                ...
                <Tooltip title={menu.title || "(Untitled Menu)"} arrow placement="right">
                  <span className="text-sm font-medium truncate">
                    {menu.title || "(Untitled Menu)"}
                  </span>
                </Tooltip>
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <div>
          <div className="text-[#e52cd2] text-2xl font-bold px-6 py-5 flex justify-center items-center gap-2">
            <Business /> LOGO
          </div>

          {/* Divider removed border */}
          <Divider  />

          {/* Navigation */}
          <nav className="flex flex-col px-4 gap-2 pt-6">
            {/* Dashboard */}
            <Link to="/superadmin/dashboard" className="w-full" onClick={() => setMobileOpen(false)}>
              <button
                className={`flex items-center gap-3 px-4 py-3 rounded-xl w-full text-sm font-medium transition-all duration-300 ${
                  location.pathname === "/superadmin/dashboard"
                    ? "bg-gradient-to-r from-[#c63bff1a] to-[#e34bff1a] text-[#c63bff]"
            ...
            {/* Menu Manager */}
            <Link to="/superadmin/menus" className="w-full" onClick={() => setMobileOpen(false)}>
              <button
                className={`flex items-center gap-3 px-4 py-3 rounded-xl w-full text-sm font-medium transition-all duration-300 ${
                  location.pathname === "/superadmin/menus"
                    ? "bg-gradient-to-r from-[#c63bff1a] to-[#e34bff1a] text-[#c63bff]"
